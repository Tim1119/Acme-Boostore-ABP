...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1204ac4f-34ce-4e35-a655-8c03b051d5cf
```

> `1204ac4f-34ce-4e35-a655-8c03b051d5cf` is the password of the certificate, you can change it to any password you want.
